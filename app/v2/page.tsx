  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
        ...
        <div className="max-w-screen-xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
          <div className="flex items-center gap-2 sm:gap-4 shrink-0">
            <div className="flex items-center gap-2">
              ...
              <a
                href="/v1"
                className="px-1.5 py-0.5 rounded text-xs font-medium bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 hover:bg-violet-100 dark:hover:bg-violet-900/40 hover:text-violet-600 dark:hover:text-violet-400 transition-colors"
              >
                v2 → v1
              </a>
            </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-10 border-t border-gray-200 dark:border-gray-800 bg-white/95 dark:bg-gray-900/95 backdrop-blur">
        <ResultsPanel scores={scores} ages={ages} selections={selections} activeBoneIndices={activeBoneIndices} sex={sex} />
        <div className="max-w-screen-xl mx-auto px-4 pb-1.5 text-[10px] text-gray-400 dark:text-gray-600">
          骨年齢換算表：日本人小児骨年齢アトラス（日本小児内分泌学会／日本成長学会［骨年齢委員会］）
          <br className="sm:hidden" />
          <span className="whitespace-nowrap sm:before:content-['／_'] ">骨の画像：</span>
          <a href="https://www.medicalmac.com/bone.htm" target="_blank" rel="noopener noreferrer" className="underline hover:text-gray-600 dark:hover:text-gray-400 mx-1">medical macintosh (Y. Yamamoto M.D.)</a>
        </div>
      </div>
    </div>
  );
